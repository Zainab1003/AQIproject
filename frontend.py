...
Original file is located at
    https://colab.research.google.com/drive/1ypag-PQPDoVe15HWguu09Xyh-xn3T0ln
"""
...
ngrok.set_auth_token("35F6O8s6LIfPPPBeF10DRPooF2J_5EyEPg7DEU1sNuV5FWWP1")

from google.colab import userdata
import os

# Get secret from Colab storage
HOPSWORKS_API_KEY = userdata.get("HOPSWORK")
OPENWEATHER_API_KEY = userdata.get("WEATHER_API")

# Save it to environment variable so Streamlit can access it
os.environ["HOPSWORK"] = HOPSWORKS_API_KEY
os.environ["WEATHER_API"] = OPENWEATHER_API_KEY
...
# HOPSWORKS_API_KEY = os.environ.get("HOPSWORK")
...
# 
# #  CRITICAL: Load model, scaler, AND features
# regressor = joblib.load(f"{model_dir}/{model_type}_model.pkl")
# scaler = joblib.load(f"{model_dir}/{model_type}_scaler.pkl")
# 
# #  FIX 2: Load feature names and USE them (don't hardcode later)
# with open(f"{model_dir}/{model_type}_features.json", 'r') as f:
#     model_features = json.load(f)['features']  # Renamed to model_features
# 
# st.success(f" Loaded {model_choice} with {len(model_features)} features")
# 
# 
# # ---------------------- FIXED OPENWEATHER FETCH ----------------------
# st.header(" Karachi: Predicted vs Actual AQI Comparison")
# 
# #  Fixed Karachi coordinates
# lat = 24.8607
# lon = 67.0011
# 
# #  Fetch API key from environment
# OPENWEATHER_API_KEY = os.environ.get("WEATHER_API")
# 
...
# 
#         #  FIX 2: Use the loaded model_features (don't hardcode again!)
...
# 
#         #  FIX 3: Apply scaler BEFORE prediction
...
# 
#         # Display results
#         st.subheader("📊 Comparison Results for Karachi")
# 
...
#         st.info(f"🔬 **Dominant Pollutant:** {dominant.upper()}")
# 
#         # Show raw pollutant values
#         with st.expander("🔍 View Raw Pollutant Data"):
#             st.json(components)
# 
#         # Debug panel
#         with st.expander("🔧 Debug: Feature Engineering"):
